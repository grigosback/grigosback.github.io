...
- **Secondly** (and perhaps more importantly), I think the best way to show the world what my interests are is by sharing what I do (or _want_ to do) in my free time. It’s a good way to show **who** I am and **how** I am.
...
- Play DOOM on a RISC-V processor built in FPGA using HLS.
